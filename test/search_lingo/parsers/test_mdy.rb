  ...
  class TestMDY < Minitest::Test # :nodoc:
    ...
    def test_parse_MMDD_relative_to_explicit_reference_date
      ...
      Date.stub :today, Date.new(2001, 12, 31) do
        assert_equal Date.new(2016,  1,  1), MDY.parse('1/1',  relative_to: ref)
        assert_equal Date.new(2015, 10,  3), MDY.parse('10/3', relative_to: ref)
        assert_equal Date.new(2016,  2, 29), MDY.parse('2/29', relative_to: ref)
      end
    end
